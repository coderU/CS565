...
Proof.
  ...
  destruct (f false) eqn:fflase.
  destruct (f true) eqn:ftrue.
  apply ftrue.
  apply fflase.
  rewrite fflase. apply fflase.
  Qed.
...
Proof.
  ...
  apply IHl1 in H1.
  simpl.
  destruct (split (combine l1 l2)) as (xs,ys).
  inversion H1.
  reflexivity.
  Qed.
...
Proof.
  unfold override.
  intros.
  destruct (beq_nat k1 k3) eqn: bk1k3.
  apply beq_nat_true in bk1k3.
  rewrite <- bk1k3.
