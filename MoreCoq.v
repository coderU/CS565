...
Proof.
  ...
  simpl in H. inversion H. rewrite<- plus_n_Sm in H1. rewrite<- plus_n_Sm in H1.
...
Proof.
  intros n X v l.
  generalize dependent n. generalize dependent v.
  induction l.  intros.
  simpl.  rewrite <- H.
  simpl.
  reflexivity.
  intros.
  destruct n as [| n'].
  simpl. apply f_equal. inversion H.
  simpl. apply f_equal. apply IHl. inversion H. reflexivity. Qed.
...
Theorem mytool: forall (X:Type) (l1 l2:list X),
